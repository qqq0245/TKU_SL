...
from src.pipeline.training_pipeline_multibranch import train_multibranch_baseline


def build_parser() -> ArgumentParser:
    parser = ArgumentParser(description="Train multibranch sign model from default dataset or split CSVs.")
